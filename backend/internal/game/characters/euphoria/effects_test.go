...
func TestEffectEuphoricSource_Increase(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			eff := euphoria.NewEffectEuphoricSource(tt.initAmount)
...
func TestEffectEuphoricSource_Decrease(t *testing.T) {
	t.Parallel()
